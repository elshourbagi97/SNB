...
export default function Shield3() {
  ...
  const translations = {
    ar: {
      firstTitle: "وسامك لليوم الثالث",
      secondTitle:
        "كلمتك اليوم تكمل عزنا و ترسم طريقنا و لسة رحلة البحث عن ثورة الوطن مستمرة ثلاثية ألغاز في أنتظارك .",
      badgeText: "أنا كاتب العز",
      langBtn: "English",
    },
    en: {
      firstTitle: "Your Badge for Day Three",
      secondTitle:
        "Your word today completes our pride and shapes our path . And the journey to the Nation’s Treasure continues … Next, a trio of riddles awaits you .",
      badgeText: "I Am a Writer of Pride",
      langBtn: "العربية",
    },
  };
  ...
  return (
    <div className="firstStep shiledpage bodyColor_organdi" >
      {/* Header */}
      ...
      <div className="containerShiled">
        ...
        <p
          ...
          style={{ lineHeight: "30px",translate:"0 17rem" }}
        >
          {t.secondTitle}
        </p>
        ...
        <div
          ...
          style={{ position: "relative",translate:"3rem -8rem" }}
        >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="480"
      ...
      {/* Footer */}
      <footer style={{background:"#54002a"}}>
