...
import Popup from "../Popup/Popup"; // ✅ الكومبوننت الموحد
  ...
  return (
    <div className="firstStep three bodyColor_move">
      ...
      <div className="header relative">
        ...
        <p className="numberQuestion">السؤال الخامس</p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bodycontent ">
          <div className="containerQuestionChoose " style={{background:"#46417e"}}>
            <div
              data-aos="zoom-in-up"
              data-aos-delay="300"
              className="question"
            ...
            >
              <h3 dir="rtl" style={{ lineHeight: "23px" }}>يمتد الممشي البحري الرئيسي في كورنيش جازان الجنوبي بطول كم متر تقريباً ؟</h3>
